...
m_len_mod <- update(m_len, subgroup = Simplified_Modality, subgroup.name = "Modality")
...
m_wid_mod <- update(m_wid, subgroup = Simplified_Modality, subgroup.name = "Modality")
...
m_thick_mod <- update(m_thick, subgroup = Simplified_Modality, subgroup.name = "Modality")
...
m_vol_mod <- update(m_vol, subgroup = Simplified_Modality, subgroup.name = "Modality")
...
m_art_mod <- update(m_art, subgroup = Simplified_Modality, subgroup.name = "Modality")
...
m_sex_mod <- update(m_sex, subgroup = Simplified_Modality, subgroup.name = "Modality")
...
m_b2_mod <- update(m_b2, subgroup = Simplified_Modality, subgroup.name = "Modality")
...
m_b3_mod <- update(m_b3, subgroup = Simplified_Modality, subgroup.name = "Modality")
